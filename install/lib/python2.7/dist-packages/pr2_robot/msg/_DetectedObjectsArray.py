...
"""autogenerated by genpy from pr2_robot/DetectedObjectsArray.msg. Do not edit."""
import sys
...
"""
  __slots__ = ['objects']
  _slot_types = ['pr2_robot/DetectedObject[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pr2_robot.msg.DetectedObject()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
