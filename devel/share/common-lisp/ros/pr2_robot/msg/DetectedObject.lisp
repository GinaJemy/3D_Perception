...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_robot-msg:<DetectedObject> is deprecated: use pr2_robot-msg:DetectedObject instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_robot-msg:label-val is deprecated.  Use pr2_robot-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_robot-msg:cloud-val is deprecated.  Use pr2_robot-msg:cloud instead.")
  (cloud m))
