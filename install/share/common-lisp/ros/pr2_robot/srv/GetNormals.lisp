...
(cl:defmethod cl:initialize-instance :after ((m <GetNormals-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNormals-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_robot-srv:<GetNormals-request> is deprecated: use pr2_robot-srv:GetNormals-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetNormals-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNormals-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_robot-srv:<GetNormals-response> is deprecated: use pr2_robot-srv:GetNormals-response instead.")))
