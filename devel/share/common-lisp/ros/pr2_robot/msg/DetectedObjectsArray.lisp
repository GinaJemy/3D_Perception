...
(cl:defclass <DetectedObjectsArray> (roslisp-msg-protocol:ros-message)
  ((objects
    :reader objects
    :initarg :objects
    :type (cl:vector pr2_robot-msg:DetectedObject)
   :initform (cl:make-array 0 :element-type 'pr2_robot-msg:DetectedObject :initial-element (cl:make-instance 'pr2_robot-msg:DetectedObject))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObjectsArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObjectsArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2_robot-msg:<DetectedObjectsArray> is deprecated: use pr2_robot-msg:DetectedObjectsArray instead.")))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <DetectedObjectsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2_robot-msg:objects-val is deprecated.  Use pr2_robot-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObjectsArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pr2_robot-msg:DetectedObject))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObjectsArray>)))
  ...
  "pr2_robot/DetectedObjectsArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObjectsArray)))
  "Returns string type for a message object of type 'DetectedObjectsArray"
  "pr2_robot/DetectedObjectsArray")
